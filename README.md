...
```
{
    ...
    "vout": [
        {
            "value": "2.00000000", //eurekacoin
            "address": "mopkoZaJGQE32h8WME5F2oBk8hvD1CVdP7"
            
        },
        {
            "value": "2.99995400", //eurekacoin
    ...
    "items": [
         {
             ...
             "vout": [
                 ...
                 {
                     "value": "0.874", //eurekacoin
                     "address": "mvYtoXgd5NCWNfPmyH8AYDyzY6kqmZ5Jt3"
                 }
             ],
             "vin": [
                 {
                     value: "1.875", //eurekacoin
                     address: "mvYtoXgd5NCWNfPmyH8AYDyzY6kqmZ5Jt3"
                 }
             ]
         },
...
[{
	...
	"link": "https://eurekacoin.org/qa-about-eurekacoin-project/",
	"title": "Q&#038;A About EurekaCoin Project",
	"body": "These questions were asked in Slack Channel...",
	"short": "These questions were asked in EurekaCoin...",
	"image": "https://eurekacoin.org/wp-content/uploads/2017/01/Telephone-Game.png"
}]
```
...
/erc20/{:erc20ContractAddress}/transfers?limit=20&offset=0&addresses[]=QMo91KVCAW9BMAeHRDYz5ib94N7pGTMmQd
...
[{
    ...
    "name": "Contract name",
    "type": "Crowdsale", // ERC20 Token || Crowdsale || Smart Contract
    "price": "4.3432344", // cost in EUREKACOIN
    "count_buy": 3,
    "count_downloads": 323,
