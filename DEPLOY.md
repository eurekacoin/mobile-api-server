## Install EUREKACOIN API

1. install mongodb https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/
2. install eurekacoin-bitcore daemon https://github.com/eurekacoin/eurekacoin-bitcore.git
3. vim ~/.eurekacoin/eurekacoin.conf
```
server=1
whitelist=127.0.0.1
txindex=1
...
rpcuser=eurekacoinuser
rpcpassword=eurekacoinpassword
rpcport=18332
reindex=1
gen=0
addrindex=1
...
4. git clone https://github.com/eurekacoin/server-receive
5. cd server-receive
6. npm install
...
13. git clone https://github.com/eurekacoin/mobile-api-server.git
