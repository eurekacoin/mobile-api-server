const logger = require('log4js').getLogger('Erc20Controller Controller');
...
class Erc20Controller {
    ...
    fetchTransfers(cb, data) {
        ...
        return InsightApiRepository.fetchErc20Transfers(contractAddress, {
            offset: offset,
            limit: limit,
            addresses: addresses
        }, (err, data) => {
...
Controllers.erc20 = new Erc20Controller();